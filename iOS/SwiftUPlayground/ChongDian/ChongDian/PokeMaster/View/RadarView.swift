        ...
        GeometryReader { proxy in
            ZStack {
                Hexagon(
                    ...
                    .animation(self.shouldAnimate ? Animation.linear(duration: 1).delay(0.2) : nil, value: progress)
                Hexagon(
                    values: self.values,
                    max: self.max,
                    progress: self.progress
                    ...
                    .animation(self.shouldAnimate ? Animation.linear(duration: 1.5).delay(0.2) : nil, value: progress)
            }
            .frame(
