//
//  DCCourseDetail.swift
//  SwiftUIDemo (iOS)
//
//  Created by MacMini on 2022/9/9.
//

import SwiftUI

struct DCCourseDetail: View {
...
struct DCCourseDetail_Previews: PreviewProvider {
    static var previews: some View {
        DCCourseDetail(course: courseData[0], show: .constant(true), active: .constant(true), actionIndex: .constant(-1))
    }
}
